              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Feature flags for production environment"
                    rows={3}
                    disabled={loading}
                    className="w-full px-3 py-2 rounded-lg bento-surface text-sm text-white placeholder-gray-600 focus:outline-none focus:border-white/10 resize-none disabled:opacity-50"
                  />
                </div>
